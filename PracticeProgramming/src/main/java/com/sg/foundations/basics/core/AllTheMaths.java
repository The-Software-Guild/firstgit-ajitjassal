...
public class AllTheMaths {
    public static void main(String[] args) {
        ...
        System.out.print("4 is greater than -1: ");
        System.out.println(4 > -1);
        
        System.out.println("\n****** Now make the computer do some harder math!");
        
        System.out.print("8043.52 minus 4.2 plus 23.0 divided by 56.0 times -76.13 is: ");
        System.out.println(8043.52 - 4.2 + 23.0 / (56) * (-76.13)); //replaced ??? with the mathematical expression
        ...
        System.out.print("67 is greater than 4 * 5: ");
        System.out.println(67 > 4 * 5);

        System.out.print("78 is less than \n 4 * 5: ");
